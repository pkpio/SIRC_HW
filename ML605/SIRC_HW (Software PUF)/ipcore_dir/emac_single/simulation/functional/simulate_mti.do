...
vlog -work work ../../example_design/emac_single.v
vlog -work work ../../example_design/emac_single_block.v
vlog -work work ../../example_design/emac_single_locallink.v
vlog -work work ../../example_design/emac_single_example_design.v
