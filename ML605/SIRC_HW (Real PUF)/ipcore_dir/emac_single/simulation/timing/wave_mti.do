...
add wave -noupdate -label dut/tx_data_i -format Literal -hex /testbench/dut/\\emac_single_locallink_inst/tx_data_i\\
add wave -noupdate -label dut/tx_data_valid_i -format Logic /testbench/dut/\\emac_single_locallink_inst/tx_data_valid_i\\
add wave -noupdate -label dut/tx_ack_i -format Logic /testbench/dut/\\emac_single_locallink_inst/tx_ack_i\\
...
add wave -noupdate -label dut/rx_data_i -format Literal -hex /testbench/dut/\\emac_single_locallink_inst/rx_data_i\\
add wave -noupdate -label dut/rx_data_valid_i -format Logic /testbench/dut/EMACCLIENTRXDVLD
add wave -noupdate -label dut/rx_good_frame_i -format Logic /testbench/dut/\\emac_single_locallink_inst/rx_good_frame_i\\
add wave -noupdate -label dut/rx_bad_frame_i -format Logic /testbench/dut/\\emac_single_locallink_inst/rx_bad_frame_i\\
