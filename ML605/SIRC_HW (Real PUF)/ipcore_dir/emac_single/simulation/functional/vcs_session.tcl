...
gui_list_add -id Wave.1 -after Tx_Client_Interface {{testbench.dut.emac_single_locallink_inst.tx_data_i}}
gui_list_add -id Wave.1 -after Tx_Client_Interface {{testbench.dut.emac_single_locallink_inst.tx_data_valid_i}}
gui_list_add -id Wave.1 -after Tx_Client_Interface {{testbench.dut.emac_single_locallink_inst.tx_ack_i}}
...
gui_list_add -id Wave.1 -after Rx_Client_Interface {{testbench.dut.emac_single_locallink_inst.rx_data_i}}
gui_list_add -id Wave.1 -after Rx_Client_Interface {{testbench.dut.emac_single_locallink_inst.rx_data_valid_i}}
gui_list_add -id Wave.1 -after Rx_Client_Interface {{testbench.dut.emac_single_locallink_inst.rx_good_frame_i}}
gui_list_add -id Wave.1 -after Rx_Client_Interface {{testbench.dut.emac_single_locallink_inst.rx_bad_frame_i}}
